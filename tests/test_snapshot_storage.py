...
class TestPickleSnapshotStorage:
    ...
    def test_load_snapshot_when_file_does_not_exist(self, storage):
        # Act
        loaded_data = storage.load_snapshot()
        loaded_last_index = storage.load_last_index()
    ...
    def test_save_snapshot_overwrites_existing_file(self, storage):
        # Arrange
        data1 = {"key1": "value1"}
        data2 = {"key2": "value2"}
        last_index1 = 1
    ...
    def test_save_snapshot_creates_file(self, storage):
        # Act
    ...
    def test_load_snapshot_with_corrupted_file(self, storage):
        # Arrange
